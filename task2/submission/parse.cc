...
PI__ const s_productionInfo[] = 
{
     ...
     {293, 1}, // 19: comments (COMMENT) ->  COMMENT
     {293, 2}, // 20: comments (COMMENT) ->  COMMENT comments
     {295, 4}, // 21: exp (OP_MOVE) ->  OP_MOVE value to_var STMT_DOT
     {295, 3}, // 22: exp (OP_READ) ->  OP_READ to_var STMT_DOT
     {295, 3}, // 23: exp (OP_WRITE) ->  OP_WRITE value STMT_DOT
     {295, 4}, // 24: exp (OP_ADD) ->  OP_ADD value to_var STMT_DOT
     {295, 5}, // 25: exp (MATH_SUB) ->  MATH_SUB value DIR_FROM VARIABLE STMT_DOT
     {295, 5}, // 26: exp (MATH_MULT) ->  MATH_MULT VARIABLE DIR_BY value STMT_DOT
     {295, 5}, // 27: exp (MATH_DIV) ->  MATH_DIV VARIABLE DIR_BY value STMT_DOT
     {295, 1}, // 28: exp ->  struct_while
     {295, 1}, // 29: exp ->  struct_if
     {302, 1}, // 30: value (VARIABLE) ->  VARIABLE
     {302, 1}, // 31: value (NUMBER) ->  NUMBER
     {303, 2}, // 32: to_var (DIR_TO) ->  DIR_TO VARIABLE
     {304, 6}, // 33: struct_while (STRUCT_WHILE) ->  STRUCT_WHILE VARIABLE STMT_DOT expressions STRUCT_ENDWHILE STMT_DOT
     {305, 5}, // 34: struct_if (STRUCT_IF) ->  STRUCT_IF logic_body if_body STRUCT_ENDIF STMT_DOT
     {306, 3}, // 35: logic_body (STMT_DOT) ->  logic_exp STMT_DOT expressions_plus
     {307, 0}, // 36: if_body ->  <empty>
     {307, 1}, // 37: if_body ->  if_else
     {307, 1}, // 38: if_body ->  if_elseif
     {309, 3}, // 39: if_else (STRUCT_ELSE) ->  STRUCT_ELSE STMT_DOT expressions
     {310, 3}, // 40: if_elseif (STRUCT_ELSEIF) ->  STRUCT_ELSEIF logic_body if_elseif
     {310, 2}, // 41: if_elseif (STRUCT_ELSEIF) ->  STRUCT_ELSEIF logic_body
     {310, 3}, // 42: if_elseif (STRUCT_ELSEIF) ->  STRUCT_ELSEIF logic_body if_else
     {308, 3}, // 43: logic_exp ->  logic_exp logic_bin_op logic_exp
     {308, 2}, // 44: logic_exp ->  logic_un_op logic_exp
     {308, 1}, // 45: logic_exp (VARIABLE) ->  VARIABLE
     {308, 1}, // 46: logic_exp (NUMBER) ->  NUMBER
     {312, 1}, // 47: logic_un_op (LOGIC_NOT) ->  LOGIC_NOT
     {311, 1}, // 48: logic_bin_op (LOGIC_AND) ->  LOGIC_AND
     {311, 1}, // 49: logic_bin_op (LOGIC_OR) ->  LOGIC_OR
     {311, 1}, // 50: logic_bin_op (COMP_LS) ->  COMP_LS
     {311, 1}, // 51: logic_bin_op (COMP_GT) ->  COMP_GT
     {311, 1}, // 52: logic_bin_op (COMP_EQ) ->  COMP_EQ
     {313, 1}, // 53: start_$ ->  start
};
