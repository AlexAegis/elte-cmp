// Generated by Bisonc++ V4.13.01 on Sat, 24 Mar 2018 22:04:31 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {294, 4}, // 17: exp (OP_MOVE) ->  OP_MOVE VARIABLE to_var STMT_DOT
     {294, 4}, // 18: exp (OP_MOVE) ->  OP_MOVE NUMBER to_var STMT_DOT
     {294, 3}, // 19: exp (OP_READ) ->  OP_READ to_var STMT_DOT
     {294, 3}, // 20: exp (OP_WRITE) ->  OP_WRITE VARIABLE STMT_DOT
     {294, 4}, // 21: exp (OP_ADD) ->  OP_ADD VARIABLE to_var STMT_DOT
     {294, 1}, // 22: exp ->  struct_while
     {294, 1}, // 23: exp ->  struct_if
     {300, 2}, // 24: to_var (DIR_TO) ->  DIR_TO VARIABLE
     {301, 6}, // 25: struct_while (STRUCT_WHILE) ->  STRUCT_WHILE VARIABLE STMT_DOT expressions STRUCT_ENDWHILE STMT_DOT
     {302, 6}, // 26: struct_if (STRUCT_IF) ->  STRUCT_IF logic_exp STMT_DOT expressions STRUCT_ENDIF STMT_DOT
     {303, 3}, // 27: logic_exp ->  logic_exp logic_bin_op logic_exp
     {303, 2}, // 28: logic_exp ->  logic_un_op logic_exp
     {303, 1}, // 29: logic_exp (VARIABLE) ->  VARIABLE
     {303, 1}, // 30: logic_exp (NUMBER) ->  NUMBER
     {305, 1}, // 31: logic_un_op (LOGIC_NOT) ->  LOGIC_NOT
     {304, 1}, // 32: logic_bin_op (LOGIC_AND) ->  LOGIC_AND
     {304, 1}, // 33: logic_bin_op (LOGIC_OR) ->  LOGIC_OR
     {304, 1}, // 34: logic_bin_op (COMP_LS) ->  COMP_LS
     {304, 1}, // 35: logic_bin_op (COMP_GT) ->  COMP_GT
     {304, 1}, // 36: logic_bin_op (COMP_EQ) ->  COMP_EQ
     {306, 1}, // 37: start_$ ->  start
};
...
SR__ s_21[] =
{
    ...
    { {       260}, { 36} }, // COMMENT      
    { {       296}, { 37} }, // var_line     
    { {       297}, { 38} }, // var_last_line
    { {       298}, { 39} }, // var_line_core
    { {       288}, { 40} }, // VARIABLE     
    { {         0}, {  0} },                 
};
