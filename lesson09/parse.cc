// Generated by Bisonc++ V4.09.02 on Mon, 16 Apr 2018 15:56:55 +0200
...
#line 66 "assign.y"
        {
         if( szimbolumtabla.count(*d_vsp__[-2].szoveg) < 1 )
         {
         std::stringstream ss;
         ss << "Hianyzo valtozo: " << *d_vsp__[-2].szoveg << ".\n" << std::endl;
         error( ss.str().c_str() );
         }
...
#line 82 "assign.y"
        {
         d_val__.tipus = new type(szimbolumtabla[*d_vsp__[0].szoveg].var_type);
         if( szimbolumtabla.count(*d_vsp__[0].szoveg) < 1 )
         {
         std::stringstream ss;
         ss << "Hianyzo valtozo: " << *d_vsp__[0].szoveg << std::endl;
         error( ss.str().c_str() );
         }
         }
        break;
...
#line 93 "assign.y"
        {
         d_val__.tipus = new type(natural);
         }
        break;
...
#line 98 "assign.y"
        {
         d_val__.tipus = new type(boolean);
         }
        break;
